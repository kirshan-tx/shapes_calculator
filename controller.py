        ...
        try: 
            ...
            if shape == -3:
                ...
                if equation == 0:
                    ...
                    if input_1 <= 0 and input_2 <= 0:
                        raise ValueError("Please enter a positive number for base and height.")
                    elif input_1 <= 0:
                        raise ValueError("Please enter a positive number for base.")
                    elif input_2 <= 0:
            ...
            if shape == -2:
                ...
                if equation == 1:
                    ...
                    if input_1 <= 0 and input_2 <= 0 and input_3 <= 0:
                        raise ValueError("Please enter a positive number for all three sides.")
                    elif input_1 <= 0:
                        raise ValueError("Please enter a positive number for first side.")
                    elif input_2 <= 0:
                        raise ValueError("Please enter a positive number for second side.")
                    elif input_3 <= 0:
                        raise ValueError("Please enter a positive number for third side.")
            ...
            if shape == -4:
                ...
                if equation == 0:
                    ...
                    if input_1 <= 0:
                        raise ValueError("Please enter a positive number for the side.")
            ...
            if 'string to float' in x:
                self.label_output_text.setText(f"Please enter only positive numbers.")
            else:
